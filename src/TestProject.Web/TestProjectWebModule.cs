...
[DependsOn(
    ...
    typeof(AbpAspNetCoreMvcUiBasicThemeModule) // ← Thêm dòng này
)]
public class TestProjectWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(TestProjectResource),
                typeof(TestProjectDomainModule).Assembly,
                typeof(TestProjectDomainSharedModule).Assembly,
                typeof(TestProjectApplicationModule).Assembly,
                typeof(TestProjectApplicationContractsModule).Assembly,
                typeof(TestProjectWebModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("TestProject");
    ...
    private void ConfigureBundles()
    {
        ...
        {
            // Configure your bundles here if needed
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<TestProjectWebModule>();
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<TestProjectWebModule>(hostingEnvironment.ContentRootPath);
            });
        }
    }
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new TestProjectMenuContributor());
        });
    }
    ...
    private void ConfigureSwaggerServices(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "TestProject API", Version = "v1" });
